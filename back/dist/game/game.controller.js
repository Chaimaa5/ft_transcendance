...
let GameController = exports.GameController = class GameController {
    ...
    async CreateChallengeMode(req, body) {
        const user = req.user;
        console.log(body);
        await this.gameService.CreateChallengeMode(user, body);
    }
    async CreateTrainingMode(req, body) {
        const user = req.user;
...
], GameController.prototype, "CreateChallengeMode", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], GameController.prototype, "CreateTrainingMode", null);
